...
export type DetalleVentaOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idDetalleVenta" | "idVenta" | "idProducto" | "cantidad" | "precioUnitario" | "subtotal", ExtArgs["result"]["detalleVenta"]>
...
export interface DetalleVentaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many DetalleVentas and only return the `idDetalleVenta`
   * const detalleVentaWithIdDetalleVentaOnly = await prisma.detalleVenta.createManyAndReturn({
   *   select: { idDetalleVenta: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more DetalleVentas and only return the `idDetalleVenta`
   * const detalleVentaWithIdDetalleVentaOnly = await prisma.detalleVenta.updateManyAndReturn({
   *   select: { idDetalleVenta: true },
   *   where: {
   *     // ... provide filter here
   *   },
